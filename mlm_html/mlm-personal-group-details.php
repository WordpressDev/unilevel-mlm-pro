...
<!--va-matter-->
    <div class="va-matter">
    	...
    	<div class="va-matterbox">
        	<!--va-headname-->
        	<div class="va-headname"><?php _e('My Personal Group Details','unilevel-mlm-pro');?></div>
            <!--/va-headname-->
			<div class="va-admin-leg-details">
				...
				<div class="paging">
				  <form action="">
					...
					<?php _e('Total Users','unilevel-mlm-pro');?>: <strong><?= $personalLegUsers; ?></strong>&nbsp;<?php _e('Active Users','unilevel-mlm-pro');?>: <strong><?= $personalLegActiveUsers; ?></strong>
					</div>

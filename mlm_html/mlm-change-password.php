...
function mlm_change_password_Page()
{ 
	$error = '';
	global $current_user;
	get_currentuserinfo();
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<form name="frm" method="post" action="" onSubmit="return updatePassword();">
		<tr>
			<td><?php _e('New Password','unilevel-mlm-pro');?> <span style="color:red;">*</span> :</td>
		...
		<tr>
			<td><?php _e('Type Again','unilevel-mlm-pro');?><span style="color:red;">*</span> :</td>
